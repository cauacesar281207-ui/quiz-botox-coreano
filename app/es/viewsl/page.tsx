...
import { createPageTracker, appendUtms } from '../../../lib/trackPageEs'
...
export default function ViewSL() {
  ...
  const tracker = useRef(createPageTracker('botox-upsell-es')).current
  ...
  const goPassar = () => {
    ...
    setTimeout(() => { window.location.href = appendUtms('/es/downsl') }, 60)
  }
